...
import { howItWorksList, successStories, faqList } from "@/constants";
  ...
  return (
    <main className="space-y-16">
      <section className="space-y-4">
        <h1 className="text-xl font-semibold md:text-3xl font-Montserrat">
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold md:text-3xl font-Montserrat">
          How it works
        </h2>
